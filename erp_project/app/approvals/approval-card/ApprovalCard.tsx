...
export default function ApprovalCard({
  ...
  // Recipe never calls insertHistoryEntry — its reason travels as a __reason__
  // sentinel approval_item instead (see RecipeLineDiffTable.tsx's parser), so
      ...
      {showDiff && (
        <div className="border-t border-border bg-muted/20 px-4 py-3">
          ...
          {isBulk ? (
            ...
            <RecipeLineDiffTable items={approval.items} materialMap={materialMap} hideReason />
          ) : (
