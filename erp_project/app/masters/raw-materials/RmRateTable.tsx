...
/* ────────────────────────── Column config ──────────────────────────────────
 * A view = an ordered list of ColumnDef. Rows are read generically
 * (string-keyed) because the two views have different shapes. The type and the
 * rendering both live in components/masters/DataTable — shared with PmRateTable
 * and MaterialMasterClient so the three tables stay identical.
 * ────────────────────────────────────────────────────────────────────────── */
...
export function RmRateTable({
  ...
  // Client-side sort (sorts within the current DB page only).
  ...
  return (
    <>
      ...
      <MasterToolbar>
        ...
        <MasterToolbarActions>
          <DownloadButton
            endpoint="/api/v1/masters/raw-materials/export"
            label="Raw Materials"
          />
          {isMfgView ? (
            <CsvImportDialog
              ...
              endpoint="/api/v1/masters/raw-materials/mrm-bulk"
            ...
            <CsvImportDialog
              ...
              endpoint="/api/v1/masters/raw-materials/vrm-bulk"
