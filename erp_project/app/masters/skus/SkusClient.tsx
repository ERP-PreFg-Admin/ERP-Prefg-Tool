...
export default function SkusClient({
  ...
  // eslint-disable-next-line react-hooks/set-state-in-effect -- resets local draft BOM filter when the URL-driven BOM filter changes
      ...
      <FilterPanel open={filterPanel.open} onClose={filterPanel.close} onApply={applyFilters} onClear={clearAllFilters}>
        ...
        <FilterField label="BOM">
          ...
          >
            ...
            <option value="missing">Missing BOM</option>
          </Select>
        </FilterField>
      </FilterPanel>
